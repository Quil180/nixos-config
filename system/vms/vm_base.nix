{ topConfig, ... }:
{
  # Shared base for the NixOS VMs: crust, baguette, scone, pancake, croissant,
  # biscuit on Proxmox, and bagel on Breadbox (TrueNAS — also KVM/virtio, so
  # the same profile fits). Per-host specifics stay in system/vms/<host>/.
